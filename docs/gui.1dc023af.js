...
var display_folder = gui.addFolder('Display');
...
// add one button
var button = {
  findNeighbor: function (_findNeighbor) {
    function findNeighbor() {
      return _findNeighbor.apply(this, arguments);
    }
    findNeighbor.toString = function () {
      return _findNeighbor.toString();
    };
    return findNeighbor;
  }(function () {
    findNeighbor();
...
function hit_the_object_in_center() {
  ...
  for (var i = 0; i < map_2d.length; i++) {
    for (var j = 0; j < map_2d[i].length; j++) {
...
var button_hit_the_object = {
  hit_the_object: function hit_the_object() {
    hit_the_object_in_center();
  }
};
button_folder.add(button_hit_the_object, 'hit_the_object').name('hit_the_object');
},{"dat.gui":"node_modules/dat.gui/build/dat.gui.module.js","three/examples/jsm/libs/stats.module.js":"node_modules/three/examples/jsm/libs/stats.module.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/gui.js"], null)
//# sourceMappingURL=/gui.1dc023af.js.map